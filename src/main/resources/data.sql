insert into products(brand_id,start_date,end_date,price_list,product_id,priority,price,currency)
    values(1,'2020-06-14 00:00:00','2020-12-31 23:59:59 ',1,35455,0,'35.40','EUR');
